...
private:
    ...
    void Input(expression &i, std::map<string, string> &key_op, std::map<string, double> &key_str, std::string &keys_);

    void Const(expression &i, map<string, string> &key_op, map<string, double> &key_str, string &keys_);
